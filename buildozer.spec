...
requirements = python3,kivy,kivymd==1.1.1,pillow,docutils,Kivy-Garden,pygments,numpy,dateutil,pytz,cython,ctypes,tzdata,certifi, idna, urllib3, chardet,peewee,appdirs,BeautifulSoup4,frozendict,multitasking
